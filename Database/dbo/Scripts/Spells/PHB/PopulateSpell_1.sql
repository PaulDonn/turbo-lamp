...
('Alarm'--Name
		  ...
		  <br/>
		  <br/>A mental alarm alerts you with a ping in your mind if you are within 1 mile of the warded area. This ping awakens you if you are sleeping.
		  <br/>
		  <br/>An audible alarm produces the sound of a hand bell for 10 seconds within 60 feet.'--Description
...
('Burning Hands'--Name
		   ...
		   <br/>
		   <br/>The fire ignites any flammable objects in the area that aren''t being worn or carried.'--Description
...
('Command'--Name
		  ...
		  <br/>
		  <br/>Some typical commands and their effects follow. You might issue a command other than one described here. If you do so, the GM determines how the target behaves. If the target can''t follow your command, the spell ends.
		  <br/>
		  <br/><strong>Approach</stong> - The target moves toward you by the shortest and most direct route, ending its turn if it moves within 5 feet of you.
		  <br/><strong>Drop</stong> - The target drops whatever it is holding and then ends its turn.
		  <br/><strong>Grovel</stong> - The target falls prone and then ends its turn.
		  <br/><strong>Halt</stong> - The target doesn''t move and takes no actions.  A flying creature stays aloft, provided that it is able to do so. If it must move to stay aloft, it flies the minimum distance needed to remain in the air.'--Description
...
('Comprehend Languages'--Name
		  ...
		  <br/>
		  <br/>This spell doesn''t decode secret messages in a text or a glyph, such as an arcane sigil, that isn''t part of a written language.'--Description
          ,null),--Higher Level Description	
...
('Create or Destroy Water'--Name
		  ...
		  <br/>
		  <br/><stong>Create Water</strong> - You create up to 10 gallons of clean water within range in an open container. Alternatively, the water falls as rain in a 30 foot cube within range, extinguishing exposed flames in the area.
		  <br/><stong>Destroy Water</strong> - You destroy up to 10 gallons of water in an open container within range. Alternatively, you destroy fog in a 30 foot cube within range.'--Description
...
('Detect Evil and Good'--Name
		  ...
		  <br/>
		  <br/>The spell can penetrate most barriers, but it is blocked by 1 foot of stone, 1 inch of common metal, a thin sheet of lead, or 3 feet of wood or dirt.'--Description
          ,null),--Higher Level Description	
...
('Disguise Self'--Name
		  ...
		  <br/>
		  <br/>The changes wrought by this spell fail to hold up to physical inspection. For example, if you use this spell to add a hat to your outfit, objects pass through the hat, and anyone who touches it would feel nothing or would feel your head and hair. If you use this spell to appear thinner than you are, the hand of someone who reaches out to touch you would bump into you while it was seemingly still in midair.
		  <br/>
		  <br/>To discern that you are disguised, a creature can use its action to inspect your appearance and must succeed on an Intelligence (Investigation) check against your spell save DC.'--Description
          ,null),--Higher Level Description	
...
('Entangle'--Name
		  ...
		  <br/>
		  <br/>When the spell ends, the conjured plants wilt away.'--Description
          ,null),--Higher Level Description	
...
('Faerie Fire'--Name
		  ...
		  <br/>
		  <br/>Any attack roll against an affected creature or object has advantage if the attacker can see it, and the affected creature or object can''t benefit from being invisible.'--Description
          ,null),--Higher Level Description
...
('Find Familiar'--Name
		   ...
		   <br/>
		   <br/>Your familiar acts independently of you, but it always obeys your commands.  In combat, it rolls its own initiative and acts on its own turn.  A familiar can''t attack, but it can take other actions as normal.
		   <br/>
		   <br/>When the familiar drops to 0 hit points, it disappears, leaving behind no physical form.  It reappears after you cast this spell again.
		   <br/>
		   <br/>While your familiar is within 100 feet of you, you can communicate with it telepathically.  Additionally, as an action, you can see through your familiar''s eyes and hear what it hears until the start of your next turn, gaining the benefits of any special senses that the familiar has.  During this time, you are deaf and blind with regard to your own senses.
		   <br/>
		   <br/>As an action, you can temporarily dismiss your familiar.  It disappears into a pocket dimension where it awaits your summons.  Alternatively, you can dismiss it forever.  As an action while it is temporarily dismissed, you can cause it to reappear in any unoccupied space within 30 feet of you.
		   <br/>
		   <br/>You can''t have more than one familiar at a time.  If you cast this spell while you already have a familiar, you instead cause it to adopt a new form.  Choose one of the forms from the above list.  Your familiar transforms into the chosen creature.
		   <br/>
		   <br/>Finally, when you cast a spell with a range of touch, your familiar can deliver the spell as if it had cast the spell.  Your familiar must be within 100 feet of you, and it must use its reaction to deliver the spell when you cast it.  If the spell requires an attack roll, you use your attack modifier for the roll.'--Description
           ,null),--Higher Level Description
...
('Goodberry'--Name
		  ...
		  <br/>
		  <br/>The berries lose their potency if they have not been consumed within 24 hours of the casting of this spell.'--Description
          ,null),--Higher Level Description
...
('Grease'--Name
		  ...
		  <br/>
		  <br/>When the grease appears, each creature standing in its area must succeed on a Dexterity saving throw or fall prone. A creature that enters the area or ends its turn there must also succeed on a Dexterity saving throw or fall prone.'--Description
          ,null),--Higher Level Description
...
('Identify'--Name
		  ...
		  <br/>
		  <br/>If you instead touch a creature throughout the casting, you learn what spells, if any, are currently affecting it.'--Description
          ,null),--Higher Level Description
...
('Illusory Script'--Name
		  ...
		  <br/>
		  <br/>Should the spell be dispelled, the original script and the illusion both disappear.
		  <br/>
		  <br/>A creature with truesight can read the hidden message.'--Description
          ,null),--Higher Level Description
...
('Sanctuary'--Name
		  ...
		  <br/>
		  <br/>If the warded creature makes an attack, casts a spell that affects an enemy, or deals damage to another creature, this spell ends.'--Description
          ,null),--Higher Level Description
...
('Silent Image'--Name
		  ...
		  <br/>
		  <br/>You can use your action to cause the image to move to any spot within range. As the image changes location, you can alter its appearance so that its movements appear natural for the image. For example, if you create an image of a creature and move it, you can alter the image so that it appears to be walking.
		  <br/>
		  <br/>Physical interaction with the image reveals it to be an illusion, because things can pass through it. A creature that uses its action to examine the image can determine that it is an illusion with a successful Intelligence (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image.'--Description
          ,null),--Higher Level Description
...
('Sleep'--Name
		  ...
		  <br/>
		  <br/>Undead and creatures immune to being charmed aren''t affected by this spell.'--Description
...
('Tasha''s Hideous Laughter'--Name
		  ...
		  <br/>
		  <br/>At the end of each of its turns, and each time it takes damage, the target can make another Wisdom saving throw. The target has advantage on the saving throw if it''s triggered by damage. On a success, the spell ends.'--Description
          ,null),--Higher Level Description
...
('Tenser''s Floating Disk'--Name
		  ...
		  <br/>
		  <br/>If you move more than 100 feet from the disk (typically because it can''t move around an obstacle to follow you), the spell ends.'--Description
          ,null),--Higher Level Description
...
('Thunderwave'--Name
		   ...
		   <br/>
		   <br/>In addition, unsecured objects that are completely within the area of effect are automatically pushed 10 feet away from you by the spell''s effect, and the spell emits a thunderous boom audible out to 300 feet.'--Description
...
('Unseen Servant'--Name
		  ...
		  <br/>
		  <br/>If you command the servant to perform a task that would move it more than 60 feet away from you, the spell ends.'--Description
          ,null),--Higher Level Description
