INSERT INTO [dbo].[Feature]
     ...
     VALUES
           ...
           ,'You have 2 sorcery points, and you gain more as you reach higher levels. You regain all spent sorcery points when you finish a long rest.'--<Description, nvarchar(max),>
           ...
           ,'When you cast a spell that has a duration of 1 minute or longer. you can spend 1 sorcery point to double its duration, to a maximum duration of 24 hours.'--<Description, nvarchar(max),>
           ,'Metamagic_ExtendedSpell'--<Code, nvarchar(50),>
		   ),
           ('Heightened Spell'--<Name, nvarchar(50),>
           ,'When you cast a spell that forces a creature to make a saving throw to resist its effects, you can spend 3 sorcery points to give one target of the spell disadvantage on its first saving throw made against the spell.'--<Description, nvarchar(max),>
           ,'Metamagic_HeightenedSpell'--<Code, nvarchar(50),>
		   ),
           ('Quickened Spell'--<Name, nvarchar(50),>
           ,'When you cast a spell that has a casting time of 1 action, you can spend 2 sorcery points to change the casting time to 1 bonus action for this casting.'--<Description, nvarchar(max),>
           ,'Metamagic_QuickenedSpell'--<Code, nvarchar(50),>
		   ),
           ('Subtle Spell'--<Name, nvarchar(50),>
           ,'When you cast a spell, you can spend 1 sorcery point to cast it without any somatic ar verbal components.'--<Description, nvarchar(max),>
           ,'Metamagic_SubtleSpell'--<Code, nvarchar(50),>
		   ),
           ('Twinned Spell'--<Name, nvarchar(50),>
           ,'When you cast a spell that targets only one creature and doesn''t have a range of self, you can spend a number of sorcery points equal to the spell''s level to target a second creature in range with the same spell (1 sorcery point if the spell is a cantrip).'--<Description, nvarchar(max),>
           ...
           ,'Starting at 6th level, you have the ability to twist fate using your wild magic. When another creature you can see makes an attack roll, an ability check, or a saving throw, you can use your reaction and spend 2 sorcery points to roll 1d4 and apply the number rolled as a bonus or penalty (your choice) to the creature''s roll. You can do so after the creature rolls but before any effects of the roll occur.'--<Description, nvarchar(max),>
           ,'WildMagicSorceror_BendLuck'--<Code, nvarchar(50),>
		   ),
           ('Controlled Chaos'--<Name, nvarchar(50),>
           ,'At 14th level, you gain a modicum of control over the surges of your wild magic. Whenever you roll on the Wild Magic Surge table, you can roll twice and use either number.'--<Description, nvarchar(max),>
           ,'WildMagicSorceror_ControlledChaos'--<Code, nvarchar(50),>
		   ),
           ('Spell Bombardment'--<Name, nvarchar(50),>
           ,'Beginning at 18th level, the harmful energy of your spells intensifies. When you roll damage for a spell and roll the highest number possible on any of the dice, choose one of those dice, roll it again and add that roll to the damage. You can use the feature only once per turn.'--<Description, nvarchar(max),>
...
INSERT INTO [dbo].[ClassFeature]
     ...
     VALUES
		   ...
		   ,1--<Level, int>
           ,'At 1st level, you know four cantrips of your choice from the sorcerer spell list. You learn additional sorcerer cantrips of your choice at higher levels, as shown in the Cantrips Known column of the Sorcerer table.'--<Description, int,>
           ,1--<Hidden, bit,>
		   ),
           ((SELECT TOP(1) Id FROM Class WHERE [Name] = 'Sorceror')--<ClassId, int,>
           ,null--<ArchetypeId, int,>
		   ...
		   ,1--<Level, int>
           ,'You can use an arcane focus as a spellcasting focus for your sorcerer spells.'--<Description, int,>
           ,1--<Hidden, bit,>
		   ),
           ((SELECT TOP(1) Id FROM Class WHERE [Name] = 'Sorceror')--<ClassId, int,>
           ,null--<ArchetypeId, int,>
