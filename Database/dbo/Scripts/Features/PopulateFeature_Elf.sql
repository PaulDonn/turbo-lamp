...
INSERT INTO [dbo].[RaceFeature]
     ...
     VALUES
		   ...
		   ,1--<Level, int>
           ,'Elves raoge from under 5 to over 6 feet tall and have slender builds. Your size is Medium.'--<Description, int,>
           ,1--<Hidden, bit,>
		   ),
           ((SELECT TOP(1) Id FROM Race WHERE [Name] = 'Elf')--<RaceId, int,>
           ,null--<SubRaceId, int,>
		   ...
		   ,1--<Level, int>
           ,'You cao speak, read, and write Common and Elvish. Elvish is fluid, with subtle intonations and intricate grammar. Elven literature is rich and varied, and their songs and poems are famous among other races. Many bards learn their language so they can add Elvish ballads to their repertoires.'--<Description, int,>
           ,1--<Hidden, bit,>
		   ),
           ((SELECT TOP(1) Id FROM Race WHERE [Name] = 'Elf')--<RaceId, int,>
           ,null--<SubRaceId, int,>
